                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mkaguzi1" id="mkaguzi1" aria-describedby="emailHelp" required>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mkaguzi2" id="mkaguzi2" aria-describedby="emailHelp" required>
                                <small id="mkf_error" class="form-text text-muted"></small>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mkaguzi3" id="mkaguzi3" aria-describedby="emailHelp" required>
                                <small id="mkf_error" class="form-text text-muted"></small>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group md-form md-outline input-with-post-icon datepicker">
                                ...
                                <input type="date" class="form-control" name="mkaguzi_date" id="mkaguzi_date" aria-describedby="emailHelp" required>
